...
popup.style.cssText =   position: fixed !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%) !important;   background: #1c2526 !important; padding: 24px !important; border-radius: 12px !important; z-index: 1000 !important;   box-shadow: 0 4px 10px rgba(0,0,0,0.5) !important; color: #eceff1 !important; text-align: center !important;   width: 90% !important; max-width: 400px !important; box-sizing: border-box !important;  ;
popup.innerHTML =   <h3 style="margin-bottom: 20px; color: #80deea; font-size: clamp(1.5rem, 3.5vw, 1.8rem);">Start Chat</h3>   <input type="email" id="emailInput" placeholder="Enter your email" style="padding: 12px; width: 100%; box-sizing: border-box; border-radius: 8px; margin-bottom: 15px; border: 1px solid #80deea; background: #263238; color: #eceff1; font-size: clamp(0.9rem, 2.5vw, 1rem);" required>   <select id="topicSelect" style="padding: 12px; width: 100%; box-sizing: border-box; border-radius: 8px; margin-bottom: 15px; border: 1px solid #80deea; background: #263238; color: #eceff1; font-size: clamp(0.9rem, 2.5vw, 1rem);" required>   <option value="" disabled selected>Select a topic</option>   <option value="Templates">Templates</option>   <option value="Pricing">Pricing</option>   <option value="Support">Support</option>   <option value="Other">Other</option>   </select>   <input type="text" id="nameInput" placeholder="Enter your name" style="padding: 12px; width: 100%; box-sizing: border-box; border-radius: 8px; margin-bottom: 15px; border: 1px solid #80deea; background: #263238; color: #eceff1; font-size: clamp(0.9rem, 2.5vw, 1rem);" required>   <button id="submitInfo" style="padding: 12px 24px; background: #4fc3f7; border: none; border-radius: 8px; color: #121212; cursor: pointer; font-size: clamp(0.9rem, 2.5vw, 1rem); transition: background 0.3s, transform 0.2s;">Start Chat</button>  ;
...
if (file) {
filePreview.innerHTML =   <div class="file-preview-item" style="display: flex; align-items: center; gap: 10px;">   <span>${file.name}</span>   <button class="delete-file" title="Remove File">✖</button>   <button class="send-file" style="padding: 5px 10px; background: #4fc3f7; border: none; border-radius: 5px; color: #000; cursor: pointer;" title="Send File">Send File</button>   <span class="loading-spinner" style="display: none; width: 20px; height: 20px; border: 3px solid #f3f3f3; border-top: 3px solid #4fc3f7; border-radius: 50%; animation: spin 1s linear infinite;"></span>   </div>   <style>   @keyframes spin {   0% { transform: rotate(0deg); }   100% { transform: rotate(360deg); }   }   </style>  ;
