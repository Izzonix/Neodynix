...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function initAdmin() {
      ...
      showConfirm('Double-check everything before submission?', async (confirmed) => {
        ...
        try {
          ...
          const data = {
            ...
            price_ugx: parseFloat(formData.get('price_ugx')),
            price_ksh: parseFloat(formData.get('price_ksh')),
            price_tsh: parseFloat(formData.get('price_tsh')),
    ...
    window.editTemplate = async (id) => {
      ...
      const priceUgxInput = document.getElementById('editPriceUgx');
      const priceKshInput = document.getElementById('editPriceKsh');
      const priceTshInput = document.getElementById('editPriceTsh');
      const priceUsdInput = document.getElementById('editPriceUsd');
      ...
      try {
        ...
        priceUgxInput.value = existingData.price_ugx.toFixed(2);
        priceKshInput.value = existingData.price_ksh.toFixed(2);
        priceTshInput.value = existingData.price_tsh.toFixed(2);
        priceUsdInput.value = existingData.price_usd.toFixed(2);
        ...
        form.onsubmit = async (e) => {
          ...
          showConfirm('Save changes to the template?', async (confirmed) => {
            ...
            let updateData = {
              ...
              price_ugx: parseFloat(priceUgxInput.value),
              price_ksh: parseFloat(priceKshInput.value),
              price_tsh: parseFloat(priceTshInput.value),
              price_usd: parseFloat(priceUsdInput.value)
            };
